                        ...
                        <ul class="team-list">
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-1.png') }}"
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-2.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-3.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-4.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-6.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-7.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-8.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-9.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-10.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-11.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="team-member">
                                    <figure>
                                        <img src="{{ asset('template/images/team-member-12.png') }}"
                                            alt="Team member image">
                                    </figure>
                            ...
                            <li>
                                <div class="gears-card">
                                    ...
                                    <div class="card-banner">
                                        ...
                                        <a href="#">
                                            <img src="{{ asset('template/images/gears-img-1.png') }}"
                                                alt="Headphone">
                                        </a>
                            ...
                            <li>
                                <div class="gears-card">
                                    ...
                                    <div class="card-banner">
                                        ...
                                        <a href="#">
                                            <img src="{{ asset('template/images/gears-img-2.png') }}"
                                                alt="Controller">
                                        </a>
                            ...
                            <li>
                                <div class="gears-card">
                                    ...
                                    <div class="card-banner">
                                        ...
                                        <a href="#">
                                            <img src="{{ asset('template/images/gears-img-3.png') }}"
                                                alt="Gaming mask">
                                        </a>
