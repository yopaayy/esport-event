        ...
        <section class="about" id="about">
          <div class="container">
            ...
            <figure class="about-banner">
              ...
              <img src="{{ asset('template/images/character-1.png') }}" alt="Game character" class="character character-1">

              <img src="{{ asset('template/images/character-2.png') }}" alt="Game character" class="character character-2">

              <img src="{{ asset('template/images/character-3.png') }}" alt="Game character" class="character character-3">
              ...
              <ul class="tournament-winners-list">
                ...
                <li>
                  <div class="winner-card">
                    ...
                    <figure class="card-banner">
                      <img src="{{ asset('template/images/winner-img-1.png') }}" alt="Winner image">
                    </figure>
                ...
                <li>
                  <div class="winner-card">
                    ...
                    <figure class="card-banner">
                      <img src="{{ asset('template/images/winner-img-2.png') }}" alt="Winner image">
                    </figure>
            ...
            <ul class="gallery-list has-scrollbar">
              ...
              <li>
                <figure class="gallery-item">
                  <img src="{{ asset('template/images/gallery-img-1.jpg') }}" alt="Gallery image">
                </figure>
              </li>

              <li>
                <figure class="gallery-item">
                  <img src="{{ asset('template/images/gallery-img-2.jpg') }}" alt="Gallery image">
                </figure>
              </li>

              <li>
                <figure class="gallery-item">
                  <img src="{{ asset('template/images/gallery-img-3.jpg') }}" alt="Gallery image">
                </figure>
              </li>

              <li>
                <figure class="gallery-item">
                  <img src="{{ asset('template/images/gallery-img-4.jpg') }}" alt="Gallery image">
                </figure>
              </li>
            ...
            <ul class="team-list">
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-1.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-2.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-3.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-4.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-6.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-7.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-8.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-9.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-10.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-11.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <a href="#" class="team-member">
                  <figure>
                    <img src="{{ asset('template/images/team-member-12.png') }}" alt="Team member image">
                  </figure>
              ...
              <li>
                <div class="gears-card">
                  ...
                  <div class="card-banner">
                    ...
                    <a href="#">
                      <img src="{{ asset('template/images/gears-img-1.png') }}" alt="Headphone">
                    </a>
              ...
              <li>
                <div class="gears-card">
                  ...
                  <div class="card-banner">
                    ...
                    <a href="#">
                      <img src="{{ asset('template/images/gears-img-2.png') }}" alt="Controller">
                    </a>
              ...
              <li>
                <div class="gears-card">
                  ...
                  <div class="card-banner">
                    ...
                    <a href="#">
                      <img src="{{ asset('template/images/gears-img-3.png') }}" alt="Gaming mask">
                    </a>
            ...
            <div class="newsletter-card">
              ...
              <div class="newsletter-content">
                <figure class="newsletter-img">
                  <img src="{{ asset('template/images/newsletter-img.png') }}" alt="Newsletter image">
                </figure>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <figure class="footer-bottom-img">
          <img src="{{ asset('template/images/footer-bottom-img.png') }}" alt="Online payment companies logo">
        </figure>
      </div>
    </div>
